...
export const API_NOTAS = "https://dappapache02.eastus.cloudapp.azure.com/middleware2-copy/api/v2/mama/xnotas";  
export const API_IMAGES = "https://dappapache02.eastus.cloudapp.azure.com/middleware2-copy/img/professionals/"; 
